...
"}"));
        ...
        layoutWidget->setGeometry(QRect(10, 19, 532, 1141));
...
"}"));
        ...
        gridLayout_4->addWidget(pushButton_2, 4, 0, 1, 2);
        ...
        gridLayout_7->addWidget(vertices_widget, 5, 0, 1, 1);
...
"}"));
        ...
        gridLayout_7->addWidget(Edges, 5, 1, 1, 1);
