...
"}"));
        ...
        gridLayout_7->addWidget(Edges, 8, 1, 1, 1);
...
"}"));
        ...
        gridLayout_7->addWidget(vertices_widget, 8, 0, 1, 1);
...
"}"));
        ...
        gridLayout_7->addWidget(widget, 7, 0, 1, 2);
...
"}"));
        ...
        gridLayout_7->addWidget(zoom_widget, 6, 0, 1, 2);
...
""));
        ...
        gridLayout_7->addWidget(rotate_widget, 3, 0, 1, 2);
...
""));
        ...
        gridLayout_7->addWidget(pushButton, 1, 0, 1, 2);
...
""));
        ...
        gridLayout_7->addWidget(proection_widget, 4, 0, 1, 2);
...
""));
        ...
        gridLayout_7->addWidget(move_widget, 2, 0, 1, 2);
...
"}"));
        ...
        gridLayout_7->addWidget(label, 9, 0, 1, 2);
        ...
        widget_3->setMinimumSize(QSize(1000, 1131));
        widget_3->setMaximumSize(QSize(1000, 1131));
        ...
        menubar->setGeometry(QRect(0, 0, 1581, 24));
